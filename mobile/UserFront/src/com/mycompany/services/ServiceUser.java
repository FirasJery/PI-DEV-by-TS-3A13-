...
public class ServiceUser {
    ...
    public void AddEntreprise(Utilisateur u) {
        String url = Statics.BASE_URL + "/utilisateur/newEntrepriseMobile?name=" + u.getName() + "&lastName=" + u.getLastName()
                + "&userName=" + u.getUserName()
                + "&password=" + u.getPassword() + "&email=" + u.getEmail() + "&image=" + u.getImagePath() + "&info=" + u.getInfo()
                + "&adresse=" + u.getAdresse() + "&nbe=" + u.getNbe() + "&domaine=" + u.getDomaine();
    ...
    public void deleteUserf(Utilisateur u) {
