...
public class AccWalletController implements Initializable {
    ...
    private void carte(ActionEvent event) {
         panne.getChildren().clear();
        FXMLLoader loadOffre = new FXMLLoader(getClass().getResource("AddCard.fxml"));
    ...
    private void transf(ActionEvent event) {
        ...
        panne.getChildren().clear();
        FXMLLoader loadOffre = new FXMLLoader(getClass().getResource("TransferSolde.fxml"));
    ...
    private void Suiv(ActionEvent event) {
         panne.getChildren().clear();
        FXMLLoader loadOffre = new FXMLLoader(getClass().getResource("SuivTrans.fxml"));
