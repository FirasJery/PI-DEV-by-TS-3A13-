...
class __TwigTemplate_9c4d2a696d02a9df937d8d3ff270742f extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 2
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 2, $this->source); })()), 'form_start', ["attr" => ["novalidate" => "novalidate", "name" => "my-form", "id" => "my-form"]]);
        echo "
    ";
        // line 3
...
{{ form_start(form, {'attr': {'novalidate': 'novalidate', 'name': 'my-form', 'id': 'my-form'}}) }}
    {{ form_widget(form) }}
    <button class=\"btn btn-warning btn-rounded btn-fw\">{{ button_label|default('Save') }}</button>
{{ form_end(form) }}
", "utilisateur/_form.html.twig", "C:\\Users\\Firas\\Desktop\\TestUser\\templates\\utilisateur\\_form.html.twig");
    }
}
