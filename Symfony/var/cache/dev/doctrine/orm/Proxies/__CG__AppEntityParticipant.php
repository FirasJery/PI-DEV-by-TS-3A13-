...
class Participant extends \App\Entity\Participant implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Participant' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Participant' . "\0" . 'user', '' . "\0" . 'App\\Entity\\Participant' . "\0" . 'conversation'];
        }
     ...
     * {@inheritDoc}
     */
    public function setUser(?\App\Entity\User $user): \App\Entity\Participant
    {
     ...
     * {@inheritDoc}
     */
    public function setConversation(?\App\Entity\Conversation $conversation): \App\Entity\Participant
    {
