...
class __TwigTemplate_2523f1679701de7e02bac41c4712c6fcc96703e2237f41b9f4d546000560a52d extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        ...
        <table>
            ...
            $context['_seq'] = twig_ensure_traversable(twig_sort_filter($this->env, twig_get_array_keys_filter(twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "bundles", [], "any", false, false, false, 217))));
    ...
    {
        return new Source("", "@WebProfiler/Collector/config.html.twig", "C:\\Users\\ASUS\\FirstProject\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\config.html.twig");
    }
}
